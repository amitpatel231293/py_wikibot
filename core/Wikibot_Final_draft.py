...
while True:
    ...
    while True:
        ...
        if option_choosen == '2':
            ...
            Viewed_from = input(
                "Enter a date to identify pages are accessed from that date or not (Enter a date in YYYYMMDD) :")
    ...
    tab11_F.header(["No:", "Not Uploaded images before specified date:", "Updated date:",
                    "Image used in page that were not edited after specified time:", "Page edited on:"])
    print(tab11_F.draw())
